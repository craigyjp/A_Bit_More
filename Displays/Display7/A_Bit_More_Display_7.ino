...
void myLEDupdate(byte channel, byte control, int value) {
  switch (control) {
    ...
    case CCeffectNumSW:
      ...
      tft.fillRoundRect(10, 10, 300, 30, 5, TFT_YELLOW);
      tft.setCursor(50, 33);
      tft.print(buf1);
      ...
      tft.fillRoundRect(180, 50, 130, 30, 5, TFT_YELLOW);  // Green box for off
      tft.setCursor(200, 73);
      tft.print("Bank:");
      tft.setCursor(280, 73);
      tft.print(panelData[P_effectBank] + 1);

      tft.fillRoundRect(180, 90, 130, 30, 5, TFT_YELLOW);  // Green box for off
      ...
      tft.fillRoundRect(180, 130, 130, 30, 5, TFT_CYAN);  // Green box for off
      // tft.setCursor(200, 138);
      // tft.print("P1");
      tft.setCursor(190, 153);
      tft.print(buf3);

      tft.fillRoundRect(180, 170, 130, 30, 5, TFT_CYAN);  // Green box for off
      // tft.setCursor(200, 178);
      // tft.print("P2");
      tft.setCursor(190, 193);
      tft.print(buf4);

      tft.fillRoundRect(180, 210, 130, 30, 5, TFT_CYAN);  // Green box for off
